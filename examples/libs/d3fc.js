(function(global, factory) {
...
}(this, function(exports, d3Array, d3Scale, d3Time, d3Random, d3Fetch, d3Path, d3Selection, d3Shape, d3Dispatch, d3Brush) {
    'use strict';
    ...
    var ohlcBase = (() => {
        ...
        let mouseevents = d => d.mouseevents;
    ...
    var ohlcBase$1 = ((pathGenerator, seriesName) => {
        ...
        const candlestick = selection => {
            ...
            selection.each((data, index, group) => {
                ...
                g.each((d, i, g) => {
                    const values = base.values(d, i);
                    const color = values.direction === 'up' ? colors.gray : colors.darkGray;
                    ...
                    if (values.mouseevents) {
                        gx.on("mouseover", (d, i) => values.mouseevents.mouseover(gx, d, i)).on("mouseout", (d, i) => values.mouseevents.mouseout(gx, d, i));
                    }
                });
                base.decorate()(g, data, index);
            });
